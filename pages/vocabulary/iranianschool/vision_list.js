    ...
    vision1: [
        {
            ...
            titleEn: "Unit 1 – Saving Nature",
            titleFa: "درس ۱ – حفظ طبیعت",
            descEn: "Learn about endangered animals and protecting the environment.",
            descFa: "آشنایی با حیوانات در حال انقراض و حفاظت از محیط زیست."
        },
        {
            unit: 2,
            icon: "fa-solid fa-earth-asia",
            titleEn: "Unit 2 – Wonders of Creation",
            titleFa: "درس ۲ – شگفتی‌های آفرینش",
            descEn: "Explore planets, wildlife, and the amazing micro-world.",
            descFa: "کاوش در سیارات، حیات وحش و جهان شگفت‌انگیز میکروسکوپی."
        },
        {
            unit: 3,
    ...
    vision2: [
        {
            ...
            titleEn: "Unit 1 – Understanding People",
            titleFa: "درس ۱ – درک متقابل انسان‌ها",
            descEn: "Explore human communication and diverse world languages.",
            descFa: "بررسی ارتباطات انسانی و زبان‌های متنوع جهان."
        },
        {
            unit: 2,
    ...
    vision3: [
        {
            ...
            titleEn: "Unit 1 – Sense of Appreciation",
            titleFa: "درس ۱ – حس قدردانی",
            descEn: "Express gratitude, respect elders, and value human contributions.",
            descFa: "ابراز سپاسگزاری، احترام به بزرگترها و ارزش نهادن به خدمات انسان‌ها."
        },
        {
            unit: 2,
